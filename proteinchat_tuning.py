...
from model.protein_chat import ProteinChatPL
from data_provider.proteinchat_dm import ProteinChatDM
...
def main(args):
    ...
    if args.init_checkpoint:
        model = ProteinChatPL.load_from_checkpoint(args.init_checkpoint, strict=False, args=args)
        print(f"loaded init checkpoint from {args.init_checkpoint}")
    else:
        model = ProteinChatPL(args)
    model.load_weight()
    ...
    # data
    dm = ProteinChatDM(args.root, args)
...
def get_args():
    ...
    parser = ProteinChatDM.add_model_specific_args(parser)
    parser = ProteinChatPL.add_model_specific_args(parser)
